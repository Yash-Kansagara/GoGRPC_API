...
func (c *studentServiceClient) GetStudents(ctx context.Context, in *GetStudentsReq, opts ...grpc.CallOption) (*Students, error) {
...
func (UnimplementedStudentServiceServer) GetStudents(context.Context, *GetStudentsReq) (*Students, error) {
...
func _StudentService_GetStudents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StudentServiceServer).GetStudents(ctx, req.(*GetStudentsReq))
	}
